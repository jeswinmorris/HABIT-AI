...
class SpeakingModel {
  ...
  async speak(text: string) {
    try {
      ...
      // the voice owns the speakers; anything else playing is suspended and resumes after
      audioBus.release('speech')
      audioBus.register({
        channel: 'speech',
        suspend: () => engineStop(),
        maybeResume: () => undefined,
        isWanted: () => speakingFlag
      })
      audioBus.claim('speech')
      setSpeaking(true)
      try {
